...
<nav className="navbar navbar-expand-lg navbar-dark  navc">
    ...
    <div className="sep" id="navbarNavDropdown">
        <div className=" form-group">
        Already Have an account? login instead
         <button type="submit" class="btn  btn-block navbut" onClick={() => history.push('/app')}>Login</button>
           </div>
           </div>
       </div>
      </nav>
...
<div className="login-main-text">
          <h1 >We are ready to set up your free trial  </h1>  
         </div>
      </div>
 <div className="main">
...
<label className="cong ">I agree to the terms</label>
